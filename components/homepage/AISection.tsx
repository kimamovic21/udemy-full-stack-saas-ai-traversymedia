          ...
          <ScrollFadeIn>
            ...
            <ul className="flex flex-col gap-4">
              {CHECKLIST.map((item) => (
                <li
                  key={item}
                  className="flex items-center gap-3 text-sm text-[#8888a4]"
                >
                  <Check
                    className="size-5 text-[#22c55e] shrink-0"
                    strokeWidth={2.5}
                  />
                  {item}
                </li>
                ...
                {[
                  ...
                  },
                  {
                    ...
                    code: (
                      <>
                        {" "}
                        <span className="text-[#c678dd]">const</span> t ={" "}
                  ...
                  },
                  {
                    ...
                    code: (
                      <>
                        ...
                        <span className="text-[#8888a4]">(</span>t
                        <span className="text-[#8888a4]">);</span>
                      </>
                    ),
                  },

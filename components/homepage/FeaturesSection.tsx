      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <ScrollFadeIn>
          <p className="text-base text-[#8888a4] max-w-[520px] mx-auto mb-16 leading-relaxed">
            Stop context-switching between tools. DevStash keeps all your
            developer resources organized and searchable.
          </p>
        </ScrollFadeIn>
          ...
          {FEATURES.map((f) => (
            <ScrollFadeIn key={f.title}>
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-2 text-[#e4e4ef]">
                  {f.title}
                </h3>
